    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'center' }}>
        <View style={{ flexDirection: 'row', justifyContent: 'center', margin: 20 }}>
          ...
          <Text style={{ fontSize: 18, fontWeight: '500', marginLeft: 10, textDecorationLine: 'underline', color: 'blue' }}>yonglzy1611@gmail.com</Text>
        </View>
        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
          <Entypo name='old-phone' size={30} color={'orange'}/>
          <Text style={{ fontSize: 18, fontWeight: '500', marginLeft: 10 }}>+65 9019 1786</Text>
        </View>
      </View>
    </View>
  )
